...
**Evaluated Date:** 2026-07-27 18:41
...
| **Context Precision @ 5** | 20.8% | ≥ 85.0% | NEEDS_TUNING |
| **Mean Reciprocal Rank (MRR)** | 0.349 | ≥ 0.850 | NEEDS_TUNING |
| **Multi-Target Recall @ 15** | 10.9% | ≥ 90.0% | NEEDS_TUNING |
| **Avg Latency** | 6465ms | < 1500ms | NEEDS_TUNING |
